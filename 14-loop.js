...
let user = { name: "Yogesh", email: "yogesh@gmail.com", password: "yogesh38" }
...
/* 
    ...
    console.log(loginUser("aasha@gmail.com", "aasha20"))
*/
...
function loginUser(inputEmail, inputPassword) {
    ...
    if(matched){
        ...
        console.log("invlid credietnasl");
    }
}

// loginUser("aasha@gmail.com", "aasha2")
